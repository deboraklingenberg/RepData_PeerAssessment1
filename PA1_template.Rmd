...
hist(totalStepsByDay$steps, xlab="Class of Total Number of Steps per day", ylab="Number of Days", col = "darkblue", main="Total Number of Steps taken each day")
...
with(averageStepsbyInterval, plot(interval, steps, type = "l", col = "darkblue"))
...
hist(totalStepsByDay1$steps, xlab="Class of Total Number of Steps per day", ylab="Number of Days", main="Number of Steps taken each day after missing values are imputed", col = "darkblue")
